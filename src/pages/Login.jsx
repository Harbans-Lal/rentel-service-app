  ...
  return (
    <>
        {toggle?(
            ...
            <p className='mt-4 mb-4'>Already have accounta ? <a className='cursor-pointer  text-blue-500' onClick={handleLog}>Login</a></p>
            ...
            <input className='mb-2 p-3 mt-3' type='text' name='uName' placeholder='username' /> 
            <input className='mb-2 p-3 mt-3'  type='password' name='passwd' placeholder='password' /> 
            <p className='mt-4 mb-4'>dont have accounta ? <a className='cursor-pointer text-blue-300' onClick={handleSign}>sign Up</a></p>
